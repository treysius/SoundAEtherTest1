    ...
    while not choice == "7":
        ...
        match choice:
            ...
            case "2":
                ...
                PlaylistNumber +=1
                db.add_playlist(name, sidList, PlaylistNumber)

            case "3":
                id = input("enter the name of the playlist")
    ...
    while True:
        ...
        match data[0]:
            ...
            case 'playlist':
                ...
                threading.Thread(target=db.get_playlist, args=(c,)).start()
