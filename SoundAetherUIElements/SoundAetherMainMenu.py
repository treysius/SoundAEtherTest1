# Form implementation generated from reading ui file 'SoundAetherMainMenu.ui'
#
...
class Ui_SAEMainMenu(object):
    def setupUi(self, SAEMainMenu):
        ...
        self.AddSongButton = QtWidgets.QPushButton(parent=SAEMainMenu)
        self.AddSongButton.setGeometry(QtCore.QRect(5, 200, 70, 40))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.AddSongButton.setFont(font)
        ...
        self.SelectPlaylistButton = QtWidgets.QPushButton(parent=SAEMainMenu)
        self.SelectPlaylistButton.setGeometry(QtCore.QRect(270, 40, 80, 23))
        self.SelectPlaylistButton.setObjectName("SelectPlaylistButton")
        self.AddPlaylistButton = QtWidgets.QPushButton(parent=SAEMainMenu)
        self.AddPlaylistButton.setGeometry(QtCore.QRect(270, 70, 80, 23))
        self.AddPlaylistButton.setObjectName("AddPlaylistButton")
        self.listWidget = QtWidgets.QListWidget(parent=SAEMainMenu)
        self.listWidget.setGeometry(QtCore.QRect(90, 21, 171, 201))
        ...
        self.AddSongButton.raise_()
        self.label_2.raise_()
        self.SelectPlaylistButton.raise_()
    ...
    def retranslateUi(self, SAEMainMenu):
        ...
        SAEMainMenu.setWindowTitle(_translate("SAEMainMenu", "Main Menu"))
        ...
        self.AddSongButton.setText(_translate("SAEMainMenu", "Add\n"
"Song"))
        self.label_2.setText(_translate("SAEMainMenu", "SoundÆther"))
        self.SelectPlaylistButton.setText(_translate("SAEMainMenu", "Select Playlist"))
        self.AddPlaylistButton.setText(_translate("SAEMainMenu", "Add Playlist"))
